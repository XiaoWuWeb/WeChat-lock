...
Page({
  ...
  lockDetailTap: function(e){
    // console.log(e.currentTarget.dataset.data);
    // console.log(this.data.appointmentType);
    if (this.data.appointmentType == 1){
      wx.setStorage({
        key: 'lockCarId',
        data: e.currentTarget.dataset.data.carId,
        success: function(res) {
          wx.setStorage({
            key: 'parkingName',
            data: e.currentTarget.dataset.data.parkingName,
            success: function (res) {
              wx.navigateTo({
                url: "../appoint/appoint"
              });
    ...
    } else if (this.data.appointmentType == 2){
      wx.setStorage({
        key: 'lockCarId',
        data: e.currentTarget.dataset.data.carId,
        success: function (res) {
